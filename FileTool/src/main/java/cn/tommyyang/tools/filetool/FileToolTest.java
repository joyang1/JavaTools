package cn.tommyyang.tools.filetool;


import cn.tommyyang.tools.filetool.Tools.ExcelTool;
import cn.tommyyang.tools.filetool.Tools.FileHepler;
import cn.tommyyang.tools.filetool.Tools.Utils;
import cn.tommyyang.tools.filetool.Tools.WordTool;
    ...
    private static  void runtxtToExcel(){
        ...
        if(directory.isDirectory()){
            ...
            for (File file:files) {
                ...
                List<String[]> datas = new FileToolTest().getDatas(questions);
